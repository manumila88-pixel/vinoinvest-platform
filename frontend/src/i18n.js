...
const ru = { nav: { dashboard: "Панель", market: "Рынок", news: "Новости", blog: "ИИ Блог", analysis: "Анализ", portfolio: "Портфель", portfolioAI: "ИИ Портфель", b2b: "B2B панель", alerts: "Уведомления", pricing: "Цены", calculator: "Калькулятор", academy: "Академия", index: "Индекс" }, hero: { title: "Глобальная Платформа для Инвестиций в Вино", subtitle: "Конструктор портфеля ИИ, аналитика вина, аналитика и поиск.", searchPlaceholder: "Поиск вин, производителей, регионов, vintages..." }, stats: { globalMarket: "Мировой рынок", portfolioValue: "Стоимость портфеля", invested: "Инвестировано", profitLoss: "Прибыль / Убыток", roi: "ROI", watchlist: "Список наблюдения" }, market: { searchPlaceholder: "Поиск любого вина в мире...", addToPortfolio: "+ Добавить в портфель", buyOn: "Купить на Wine-Searcher →", noWines: "Вина не найдены.", loadingMore: "Загрузка вин…", aiScoreHint: "Используйте AI Score VinoInvest для поиска лучших инвестиционных возможностей." }, watchlist: { title: "Анализ списка наблюдения", empty: "Добавьте вина в список наблюдения из раздела Рынок." }, auth: { signOut: "Выйти", serverStarting: "⚡ Сервер запускается...", offline: "⚠️ Нет соединения" }, notifications: { title: "Уведомления", enablePush: "🔔 Включить Push", markAllRead: "Отметить всё прочитанным", noNotifications: "Уведомлений пока нет.", pushEnabled: "Push-уведомления включены!" }, common: { loading: "Загрузка...", loadingDashboard: "Загрузка панели...", loadingData: "Загрузка данных...", loadingProducers: "Загрузка данных производителей...", noData: "Нет данных", refresh: "Обновить", save: "Сохранить", cancel: "Отмена", close: "Закрыть", back: "Назад", error: "Ошибка", success: "Успех" }, modal: { producer: "Производитель", vintageQuality: "Качество урожая", vintageScore: "Урожай {{year}}: {{score}}/100", searchVivino: "🍇 Найти на Vivino" }, purchase: { loadingPlatforms: "Загрузка платформ...", addExisting: "Добавьте существующую покупку в ваш портфель.", pricePaid: "Цена покупки (€)", purchaseDate: "Дата покупки", affiliateNote: "Партнёрские ссылки — VinoInvest может получать комиссию от покупок" }, chat: { agentHint: "Общайтесь с вашим ИИ-советником — анализ портфеля, рыночные новости, возможности." }, chart: { realData: "Реальные данные", estimated: "Расчётные данные", mixed: "Смешанные" }, analysis: { algorithmicNote: "* Алгоритмический анализ (ANTHROPIC_API_KEY не настроен на сервере)" }, portfolio: { ...en.portfolio, demo: "Вы просматриваете демо-портфель", addFirstWine: "Добавьте своё первое настоящее вино →" }, calc: { title: "Инвестиционный калькулятор", guidedTour: "Обзорная экскурсия", closeTour: "Закрыть экскурсию", step: "Шаг", initialBudget: "Начальный бюджет", horizon: "Временной горизонт", year: "год", years: "лет", conservative: "Консервативный", balanced: "Сбалансированный", aggressive: "Агрессивный", conservativeDesc: "Ожидаемая доходность 4–6%/год, низкая волатильность. Идеально для сохранения капитала. Упор на Bordeaux Premiers Crus со стабильными ликвидными рынками.", balancedDesc: "Ожидаемая доходность 7–10%/год, средняя волатильность. Микс регионов: Bordeaux, Бургундия, Тоскана. Хорошее соотношение риск/доходность на 5–7 лет.", aggressiveDesc: "Ожидаемая доходность 11–15%/год, высокая волатильность. Развивающиеся регионы, редкие урожаи и коллекционные вина. Лучший вариант на 10+ лет.", lowVolatility: "Низкая волатильность", mediumVolatility: "Средняя волатильность", highVolatility: "Высокая волатильность", investment: "Инвестиции", projectedValue: "Прогнозируемая стоимость", totalROI: "Общий ROI", confidenceBand: "Доверительный интервал", centralProjection: "Центральный прогноз", disclaimer: "Ориентировочный прогноз на основе исторической доходности fine wine. Не является финансовым советом.", tourBudgetTitle: "Начальный бюджет", tourBudgetDesc: "Установите сумму для инвестирования в fine wine. От €1.000 до €500.000.", tourHorizonTitle: "Временной горизонт", tourHorizonDesc: "Выдержанное вино значительно дорожает за 5–10 лет. Более долгие сроки снижают риск.", tourRiskTitle: "Профиль риска", tourRiskDesc: "Наведите на вариант для просмотра ожидаемой доходности и волатильности.", tourSummaryTitle: "Прогнозируемая стоимость", tourSummaryDesc: "Центральная оценка стоимости портфеля на конец выбранного горизонта.", tourChartTitle: "Доверительный интервал", tourChartDesc: "Затенённая область показывает диапазон вероятных результатов. Расширяется со временем." }, b2b: { headerTitle: "VinoInvest Professional", badge: "PRO", aum: "Объём управления", clients: "Активные клиенты", performance: "Средн. доходность", viewAsB2B: "Вид B2B", viewAsB2C: "Вид B2C", marketIntelligence: "Рыночная аналитика", reports: "Отчёты", clientsNav: "Клиенты", premiumOnly: "Только премиальные вина (>€200)" } };
const nl = { nav: { dashboard: "Dashboard", market: "Markt", news: "Nieuws", blog: "AI Blog", analysis: "Analyse", portfolio: "Mijn Portfolio", portfolioAI: "AI Portfolio", b2b: "B2B Dashboard", alerts: "Meldingen", pricing: "Prijzen", calculator: "Rekenmachine", academy: "Academy", index: "Index" }, hero: { title: "Mondiaal Wijninvesteringsplatform", subtitle: "AI portfolio builder, wijnintelligentie, analyses en wereldwijde zoekopdrachten.", searchPlaceholder: "Zoek wijnen, producenten, regio's, jaargangen..." }, stats: { globalMarket: "Wereldmarkt", portfolioValue: "Portfoliowaarde", invested: "Geïnvesteerd", profitLoss: "Winst / Verlies", roi: "ROI", watchlist: "Volglijst" }, market: { searchPlaceholder: "Zoek elke wijn wereldwijd...", addToPortfolio: "+ Toevoegen aan Portfolio", buyOn: "Kopen op Wine-Searcher →", noWines: "Geen wijnen gevonden.", loadingMore: "Meer wijnen laden…", aiScoreHint: "Gebruik de VinoInvest AI Score om de beste investeringsmogelijkheden te vinden." }, watchlist: { title: "Watchlist Analyse", empty: "Voeg wijnen toe aan je watchlist vanuit de Markt sectie." }, auth: { signOut: "Uitloggen", serverStarting: "⚡ Server start op...", offline: "⚠️ Geen verbinding" }, notifications: { title: "Meldingen", enablePush: "🔔 Push inschakelen", markAllRead: "Alles als gelezen markeren", noNotifications: "Nog geen meldingen.", pushEnabled: "Push-meldingen ingeschakeld!" }, common: { loading: "Laden...", loadingDashboard: "Dashboard laden...", loadingData: "Gegevens laden...", loadingProducers: "Producentgegevens laden...", noData: "Geen gegevens", refresh: "Vernieuwen", save: "Opslaan", cancel: "Annuleren", close: "Sluiten", back: "Terug", error: "Fout", success: "Succes" }, modal: { producer: "Producent", vintageQuality: "Jaargangkwaliteit", vintageScore: "Jaargang {{year}}: {{score}}/100", searchVivino: "🍇 Zoeken op Vivino" }, purchase: { loadingPlatforms: "Platforms laden...", addExisting: "Voeg een bestaande aankoop toe aan uw portfolio.", pricePaid: "Aankoopprijs (€)", purchaseDate: "Aankoopdatum", affiliateNote: "Affiliate links — VinoInvest kan een commissie ontvangen op aankopen" }, chat: { agentHint: "Chat met uw AI-adviseur — portefeuilleanalyse, marktnieuws, kansen." }, chart: { realData: "Echte data", estimated: "Geschatte data", mixed: "Gemengd" }, analysis: en.analysis, disclaimer: en.disclaimer, portfolio: { ...en.portfolio, demo: "U bekijkt een DEMO portfolio", addFirstWine: "Voeg uw eerste echte wijn toe →" }, calc: { title: "Investeringscalculator", guidedTour: "Rondleiding", closeTour: "Rondleiding sluiten", step: "Stap", initialBudget: "Beginbudget", horizon: "Tijdshorizon", year: "jaar", years: "jaar", conservative: "Conservatief", balanced: "Gebalanceerd", aggressive: "Agressief", conservativeDesc: "Verwacht rendement 4–6%/jaar, lage volatiliteit. Ideaal voor kapitaalsbehoud. Focus op Bordeaux Premiers Crus.", balancedDesc: "Verwacht rendement 7–10%/jaar, gemiddelde volatiliteit. Mix van Bordeaux, Bourgondië, Toscane.", aggressiveDesc: "Verwacht rendement 11–15%/jaar, hoge volatiliteit. Opkomende regio's, topjaargangen.", lowVolatility: "Lage volatiliteit", mediumVolatility: "Gemiddelde volatiliteit", highVolatility: "Hoge volatiliteit", investment: "Investering", projectedValue: "Verwachte waarde", totalROI: "Totaal ROI", confidenceBand: "Betrouwbaarheidsband", centralProjection: "Centrale projectie", disclaimer: "Indicatieve projectie op basis van historische fine wine rendementen. Geen financieel advies.", tourBudgetTitle: "Beginbudget", tourBudgetDesc: "Stel het te investeren bedrag vast. Van €1.000 tot €500.000.", tourHorizonTitle: "Tijdshorizon", tourHorizonDesc: "Fine wine stijgt in waarde over 5–10 jaar. Langere horizons verlagen het risico.", tourRiskTitle: "Risicoprofiel", tourRiskDesc: "Beweeg over elke optie voor details over rendementen en volatiliteit.", tourSummaryTitle: "Verwachte waarde", tourSummaryDesc: "De centrale schatting van uw portfoliowaarde aan het einde van de gekozen horizon.", tourChartTitle: "Betrouwbaarheidsband", tourChartDesc: "Het gearceerde gebied toont de waarschijnlijke uitkomsten. Het wordt breder met de tijd." }, b2b: { headerTitle: "VinoInvest Professional", badge: "PRO", aum: "Beheerd vermogen", clients: "Actieve Klanten", performance: "Gem. rendement", viewAsB2B: "B2B weergave", viewAsB2C: "B2C weergave", marketIntelligence: "Marktintelligentie", reports: "Rapporten", clientsNav: "Klanten", premiumOnly: "Alleen premium wijnen (>€200)" } };
