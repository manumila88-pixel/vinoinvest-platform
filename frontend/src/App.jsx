...
import { API, ADMIN_EMAIL as ADMIN_EMAIL_CONST, SITE_URL, SITE_HOST } from "./lib/constants";
  ...
  return (
    <div className="app">
      <Helmet>
        ...
        <link rel="canonical" href={`${SITE_URL}${tab !== "dashboard" ? `/${tab}` : ""}`} />
      </Helmet>
      {/* ── Offline banner ───────────────────────────────────────────────── */}
      {backendWaking && (
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        doc.text(`Generated by VinoInvest · ${SITE_HOST} · Data sources: Wine-Searcher, CellarTracker, Liv-ex`, 14, 200);
