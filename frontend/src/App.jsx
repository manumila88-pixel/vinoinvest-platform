        ...
        <section className="content">
            ...
            <>
              <section className="hero">
                <div className="heroText">
                  ...
                  <p>Backend collegato. Database attivo. Sistema pronto per API reali.</p>
                </div>
              </section>
            ...
            <section className="marketGrid">
              {wines.map(wine => (
                <div className="wineCard" key={wine.id}>
                  ...
                  <button onClick={() => buyWine(wine.id)}>Compra</button>
                </div>
              ))}
            </section>
          )}
          ...
          {tab === "orders" && (
            <section className="ordersPanel">
              ...
              {orders.length === 0 && <p>Nessun ordine registrato.</p>}
