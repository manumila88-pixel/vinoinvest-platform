...
Latour ha fatto una mossa strategica brillante nel 2012: ha abbandonato l'en primeur, dichiarando che venderà solo quando i vini saranno pronti a bere (almeno 10–15 anni dopo la vendemmia). Questo ha creato scarsità, aumentato la percezione di esclusività e ridotto la speculazione a breve termine. La conseguenza sul prezzo: un apprezzamento marcato nei mesi successivi all'annuncio, con stabilizzazione su valori superiori rispetto a prima (serie storiche su liv-ex.com). Per gli investitori che avevano già Latour in magazzino era un regalo. Per chi voleva comprare en primeur, una porta chiusa.
