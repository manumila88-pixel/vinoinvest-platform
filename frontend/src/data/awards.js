...
export const AWARDS = [
  ...
  // ── Tre Bicchieri – additional producers ──────────────────────────────
  {
    producer: "Vietti",
    wine_keywords: ["barolo", "brunate", "castiglione", "lazzarito", "rocche"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  ...
  {
    producer: "Sandrone",
    wine_keywords: ["barolo", "cannubi boschis", "aleste", "vite talin"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    producer: "Ceretto",
    wine_keywords: ["barolo", "bricco rocche", "brunate", "prap"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    ...
    wine_keywords: ["barbaresco", "barolo", "vursu", "starderi", "valeirano"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    producer: "Allegrini",
    wine_keywords: ["amarone", "la poja", "palazzo della torre"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    ...
    wine_keywords: ["amarone", "valpolicella"],
    award: "Tre Bicchieri",
    year: 2023,
    emoji: "🏆",
  },
  {
    producer: "Masi",
    wine_keywords: ["amarone", "costasera", "campolongo"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  ...
  },
  {
    ...
    wine_keywords: ["brunello", "brunello di montalcino"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    ...
    wine_keywords: ["brunello", "brunello di montalcino", "riserva"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  ...
  },
  {
    ...
    wine_keywords: ["brunello", "cerretalto", "tenuta nuova"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    ...
    wine_keywords: ["tignanello", "solaia", "guado al tasso"],
    award: "Tre Bicchieri",
    year: 2024,
    emoji: "🏆",
  },
  {
    ...
    wine_keywords: ["masseto", "ornellaia", "castelgiocondo"],
    award: "Tre Bicchieri",
    year: 2023,
    emoji: "🏆",
  },
  ...
  },
  {
    ...
    wine_keywords: ["unico", "valbuena", "vega sicilia"],
    award: "Decanter Platinum",
    year: 2024,
    emoji: "🥇",
  },
  {
    producer: "Pingus",
    wine_keywords: ["pingus", "flor de pingus"],
    award: "Decanter Platinum",
    year: 2023,
    emoji: "🥇",
  },
  ...
  },
  {
    ...
    wine_keywords: ["chambertin", "musigny", "richebourg", "romanee saint vivant"],
    award: "Decanter Platinum",
    year: 2023,
    emoji: "🥇",
  },
  {
    ...
    wine_keywords: ["scharzhofberger", "trockenbeerenauslese", "tba", "auslese"],
    award: "Decanter Platinum",
    year: 2023,
    emoji: "🥇",
  },
  ...
  {
    producer: "Biondi-Santi",
    wine_keywords: ["brunello", "riserva"],
    award: "Wine Spectator Top 100",
    year: 2023,
    emoji: "🍷",
  },
  {
    ...
    wine_keywords: ["haut-brion", "haut brion"],
    award: "Wine Spectator Top 100",
    year: 2024,
    emoji: "🍷",
  },
  ...
  {
    producer: "Domaine de la Romanée-Conti",
    wine_keywords: ["romanee-conti", "romanée-conti", "drc", "romanee conti", "la tache", "richebourg"],
    award: "WE Top 100",
    year: 2024,
    emoji: "🌟",
  },
  ...
  {
    producer: "Vietti",
    wine_keywords: ["barolo", "brunate", "castiglione", "lazzarito"],
    award: "WE Top 100",
    year: 2024,
    emoji: "🌟",
  },
  ...
  },
  {
    ...
    wine_keywords: ["adrianna", "malbec", "la consulta"],
    award: "WE Top 100",
    year: 2024,
    emoji: "🌟",
  },
  ...
  {
    producer: "Domaine de la Romanée-Conti",
    wine_keywords: ["romanee-conti", "romanée-conti", "drc"],
    award: "JS 100 pts",
    year: 2022,
    emoji: "💯",
  },
  ...
  {
    producer: "Domaine Leroy",
    wine_keywords: ["chambertin", "musigny"],
    award: "RP 100 pts",
    year: 2005,
    emoji: "⭐",
  },
  ...
  {
    producer: "Egon Müller",
    wine_keywords: ["scharzhofberger", "trockenbeerenauslese", "tba"],
    award: "RP 100 pts",
    year: 2003,
    emoji: "⭐",
  },
