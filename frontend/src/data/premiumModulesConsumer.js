...
**Insight del Pro**
La bassa correlazione vale sul lungo periodo. Nei giorni successivi a un crash violento, il vino può temporaneamente correlare più in alto, perché i collezionisti HNW vendono tutto per soddisfare margin call. Il momento ideale di acquisto è spesso proprio allora.
...
**Insight del Pro**
L'Italia ha mostrato negli ultimi anni un rapporto rischio/rendimento aggiustato per liquidità interessante, grazie anche all'ingresso di collezionisti asiatici. La quota del Barolo sul mercato asiatico è cresciuta in modo strutturale — la crescita della domanda appare ancora nelle fasi iniziali.
...
La gestione della concentrazione è il rischio più sottovalutato nel fine wine investment. A differenza delle azioni, dove la diversificazione si ottiene facilmente con ETF e migliaia di titoli, nel fine wine ogni posizione richiede capitale significativo e la liquidità è limitata. Una singola bottiglia di Pétrus che si rompe, una cantina o un produttore coinvolto in un caso di frode documentato (come l'affaire Rudy Kurniawan) o una semplice variazione di gusto dei critici può azzerare una posizione non correttamente dimensionata.
...
**Fonte**: Liv-ex Price Database 2017-2023; Wine Advocate; Decanter Fine Wine Portfolio Guide` },
    ...
    quiz: [
      { q: "Sul lungo periodo, la correlazione tra fine wine e mercati azionari è tipicamente:", options: ["Molto alta (si muovono insieme)", "Moderata e stabile", "Storicamente bassa (buon diversificatore)", "Sistematicamente negativa"], correct: 2 },
...
**Insight del Pro**
La correlazione wine/equity tende a salire durante le crisi severe (2008, 2020). La bassa correlazione non è garantita in assoluto — è un fenomeno che si riduce quando tutti vendono tutto. Pianifica la tua liquidità di conseguenza.
...
**Insight del Pro**
Per portafogli wine sotto €500k, la regola empirica 1/N (allocazione uguale tra asset class) si è dimostrata sorprendentemente robusta rispetto all'MVO su dati fuori campione in gran parte della letteratura (cfr. DeMiguel, Garlappi, Uppal, 2009). La semplicità è un edge reale, non una scusa per pigrizia analitica.
...
**Caso Studio Reale**
Esempio illustrativo (ipotetico): un investitore con un portfolio wine concentrato su Bordeaux e Borgogna usa Python + scipy.optimize con dati Liv-ex per riottimizzare la propria allocazione. L'analisi rileva un'eccessiva concentrazione su un singolo areale (per esempio Pomerol) rispetto al peso ottimale suggerito dal modello. Vendendo parte della posizione sovra-pesata e reinvestendo in regioni meno correlate (Barolo, Napa Valley), il portfolio diventa strutturalmente più resistente alle correzioni regionali. Il meccanismo è generale: ridurre la concentrazione abbassa il rischio idiosincratico senza sacrificare il rendimento atteso.
...
**Fonte**: Liv-ex API Documentation 2024; CellarTracker.com User Data Report 2023; Wine-Searcher Pro Technical Documentation; Christie's Wine Department Annual Report 2023` },
    ...
    quiz: [
      ...
      { q: "Aggiungere fine wine a bassa correlazione a un portafoglio equity, a parità di rendimento atteso:", options: ["Aumenta il tail risk", "Non ha alcun effetto sul rischio", "Tende a ridurre il tail risk complessivo", "Elimina completamente il rischio"], correct: 2 },
    ],
  },
...
**Insight del Pro** — La correlazione Borgogna/Italia tende a ridursi ulteriormente durante le crisi politiche europee (es. Brexit 2016, elezioni francesi). In quei momenti, il vino italiano da investimento si comporta quasi come un safe haven regionale rispetto alla Borgogna.
...
**Fonte**: Liv-ex Monthly Market Report (open access); Decanter Fine Wine Investment newsletter; BIVB Burgundy Market Report 2023-2024; Wine Advocate Vintage Report Archive; INRAE French Harvest Forecast (annuale)` },
    ...
    quiz: [
      ...
      { q: "La correlazione tra Bordeaux e Italia è tipicamente:", options: ["Quasi perfetta (si muovono identici)", "Molto alta", "Contenuta (buona diversificazione inter-regionale)", "Fortemente negativa"], correct: 2 },
    ],
  },
  { title: "Annate: Come il Vintage Determina il Valore", duration: 13,
    ...
    context: "Non tutti i millésime sono uguali: un Bordeaux di un'annata eccezionale come il 2000 e uno di un'annata debole come il 2007, sulla stessa proprietà, possono differire enormemente in valore. Come usare le vintage charts per prendere decisioni di acquisto e vendita ottimali.",
...
**Fonte**: Wine-Searcher Price Historical Database; Christie's Market Review 2022; Wine Advocate Investment Portfolio Guide; IWSR Fine Wine Tracking Report.` },
    ...
    quiz: [
      ...
      { q: "Rispetto a un'annata ordinaria, un'annata eccezionale della stessa proprietà tende a valere:", options: ["Praticamente uguale", "Poco di più", "Molto di più, con differenziale che cresce nel tempo", "Meno, perché più vecchia"], correct: 2 },
      ...
      { q: "La relazione tra punteggio critico (Parker) e prezzo finale è:", options: ["Quasi assente", "Debole", "Storicamente forte", "Perfetta e deterministica"], correct: 2 },
...
export const EN_PRIMEUR_AVANZATO_MODULES = buildModules(13, "En Primeur Avanzato", [
  { t: "La Campagna En Primeur: Anatomia e Calendar", ctx: "Il meccanismo completo della campagna en primeur di Bordeaux: dal vendemmia al prezzo di release, come partecipare professionalmente.", dd: "La campagna en primeur si svolge ogni primavera (marzo-maggio) per l'annata precedente — un meccanismo secolare del mercato bordolese che permette alle châteaux di vendere il vino prima dell'imbottigliamento e agli investitori di acquistare a prezzi futures con potenziale di apprezzamento.\n\nIl calendario completo di una campagna en primeur: ottobre-novembre dell'anno di vendemmia — i vini vengono vinificati e trasferiti in botti nuove di rovere francese. Gennaio-febbraio dell'anno successivo — il vino affina in botte e i premier tastings avvengono internamente. Marzo — i grandi critici internazionali (Wine Advocate, Wine Spectator, Vinous, James Suckling) visitano le cantine di Bordeaux per l'assemblage tasting. I campioni assaggiati sono ancora molto giovani e tannici — la valutazione richiede esperienza per proiettare il potenziale finale. Aprile-maggio — pubblicazione dei punteggi en primeur. Maggio-giugno — le châteaux rilasciano le prime tranche di prezzo attraverso i négociants della Place de Bordeaux. Gli acquirenti pagano subito (50% all'ordine, 50% alla consegna in alcuni casi). Gennaio-marzo del secondo anno successivo alla vendemmia — imbottigliamento. Marzo-aprile dello stesso anno — consegna fisica ai merchant e ingresso nel mercato spot Liv-ex.\n\nPerché la campagna en primeur è importante per il fine wine advisor: il prezzo en primeur è spesso il punto di ingresso più economico per i vini di alta qualità — ma non sempre. Le grandi châteaux hanno imparato a prezzare l'en primeur vicino o sopra il valore di mercato atteso, rendendo il vantaggio del prezzo futures sempre meno evidente. Il fine wine advisor deve calcolare l'Expected Total Return prima di ogni acquisto en primeur per verificare se l'investimento è conveniente rispetto all'acquisto nel mercato spot tra 2-3 anni.\n\nIl rischio specifico dell'en primeur: a differenza dell'acquisto nel mercato spot, l'en primeur espone l'investitore al rischio di controparte (il merchant intermediario fallisce prima della consegna), al rischio qualità (i punteggi critici possono essere rivisti dopo l'imbottigliamento), e al rischio liquidità (i vini en primeur non sono tradeable su Liv-ex prima dell'imbottigliamento).\n\n**Takeaway chiave:**\n- Calendario: vendemmia ottobre → critici visitano marzo → punteggi aprile-maggio → tranche prezzo maggio-giugno → imbottigliamento 18-24 mesi → consegna fisica e Liv-ex spot\n- I punteggi en primeur sono su vini molto giovani — soggetti a revisione al momento dell'imbottigliamento (rischio di downgrade del punteggio)\n- Non sempre conveniente: le grandi châteaux prezzano l'en primeur vicino al valore di mercato atteso — calcolare sempre l'ETR prima di acquistare\n- Tre rischi specifici en primeur: controparte (merchant che fallisce), qualità (punteggio rivisto), liquidità (non tradeable su Liv-ex prima dell'imbottigliamento)\n- Regola: acquistare en primeur solo se ETR >15% rispetto all'acquisto spot atteso tra 2-3 anni — altrimenti aspettare il mercato spot",       slides: [
      ...
      **Il Meccanismo**
      Sulla Place de Bordeaux operano diverse centinaia di négociants, ma una minoranza di case controlla la maggior parte dei volumi en primeur dei châteaux iconici. I tre merchant UK di riferimento — Berry Bros & Rudd (fondata nel 1698), Farr Vintners (specialista Borgogna/Bordeaux, con allocazioni dirette su etichette come Pétrus e Le Pin), Justerini & Brooks (di proprietà Diageo) — fungono da gateway. La relazione con un négoce si costruisce attraverso acquisti regolari: anche nelle annate deboli (2013, 2017, 2021 Bordeaux), comprare piccoli lotti mantiene viva la relazione e garantisce priorità nelle annate eccezionali. La regola non scritta: chi non compra nelle annate difficili non riceve allocazioni nelle annate facili.
      
      **Caso Studio Reale**
      Scenario illustrativo: un family office con €2M di wine portfolio aveva comprato sistematicamente Bordeaux en primeur dal 2011 al 2021, anche nelle annate deboli (2013, 2017). Quando nel 2022 è arrivata la campagna 2021 — annata mediocre — ha comprato comunque piccoli lotti da Farr Vintners. Risultato: per la campagna 2022 (annata eccezionale, punteggi record), ha ricevuto un'allocazione di 24 bottiglie di Pétrus 2022 a £850 cadauna. Il prezzo sul mercato secondario alla consegna risultava già sensibilmente superiore al prezzo en primeur pagato. Senza la fedeltà nelle annate deboli, quell'allocazione non sarebbe mai arrivata.
      ...
      **Caso Studio Reale**
      Esempio illustrativo (ipotetico): un family office con capitale iniziale di circa €80.000 nella campagna 2018 struttura così l'allocazione. 40% (€32k) su 6 posizioni Left Bank 2018 (Margaux, Pichon Baron, Léoville Las Cases, Ducru, Lynch Bages, Beychevelle). 25% (€20k) su Champagne: Dom Pérignon 2012 e Krug 2011 (consegna immediata, non en primeur). 20% (€16k) Borgogna: Clos de Vougeot Grand Cru premier tasting. 15% (€12k) cash per opportunità secondario. Il razionale della struttura: la quota Champagne e il cash riservato per opportunità spot riducono la volatilità complessiva del portafoglio, coerentemente con il valore della diversificazione strutturata. I rendimenti effettivi dipendono da annate e condizioni di mercato e vanno verificati sui dati reali.
