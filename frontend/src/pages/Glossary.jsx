...
const TERMS = [
  ...
  { term: "ROI (Return on Investment)", def: "Rendimento dell'investimento. Nel fine wine, il ROI medio storico è dell'8-10% annuo. DRC e vini ultra-rari hanno superato il 15% annuo nell'ultimo decennio." },
  { term: "Sassicaia", def: "Il primo Super Tuscan riconosciuto DOC (1968). Tenuta San Guido, Bolgheri. Cabernet Sauvignon e Cabernet Franc. Considerato il 'Petite Pomerol' d'Italia." },
